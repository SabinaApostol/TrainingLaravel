...
Route::post('products', 'App\Http\Controllers\ProductsController@destroy')->name('products.destroy');

Route::put('product/{id}', 'App\Http\Controllers\ProductController@update')->name('product.update');
Route::post('product/{id}', 'App\Http\Controllers\ProductController@update')->name('product_spa.update');
